...
class Pixoo:
    ...
    def get_all_setting(self):
        ...
        _brightness = resp_json["Brightness"]
        _rotation_flag = resp_json["RotationFlag"]
        _clock_time = resp_json["ClockTime"]
        _gallery_time = resp_json["GalleryTime"]
        _single_gallery_time = resp_json["SingleGalleyTime"]
        _power_on_channel_id = resp_json["PowerOnChannelId"]
        _gallery_show_time_flag = resp_json["GalleryShowTimeFlag"]
        _cur_clock_id = resp_json["CurClockId"]
        _time_24_flag = resp_json["Time24Flag"]
        _temperature_mode = resp_json["TemperatureMode"]
        _gyrate_angle = resp_json["GyrateAngle"]
        _mirror_flag = resp_json["MirrorFlag"]
        _light_switch = resp_json["LightSwitch"]
    ...
    def set_white_balance(self, r_value, g_value, b_value):
        ...
        data = {"Command": "Device/SetHighLightMode", "RValue": r_value, "GValue": g_value, "BValue": b_value}
        self._local_post(data)
    ...
    def set_countdown_tool(self, minute, second, status):
        ...
        ''' 
        data = {"Command": "Tools/SetTimer", "Minute": minute, "Second": second, "Status": status}
        self._local_post(data)
    ...
    def set_stopwatch_tool(self, status):
        ...
        :param status: 1: start; 0: stop
        ''' 
        data = {"Command": "Tools/SetStopWatch", "Status": status}
        self._local_post(data)
    ...
    def set_scoreboard_tool(self, blue_score, red_score):
        ...
        ''' 
        data = {"Command": "Tools/SetScoreBoard", "BlueScore": blue_score, "RedScore": red_score}
        self._local_post(data)
    ...
    def set_noise_tool(self, noise_status):
        ...
        ''' 
        data = {"Command": "Tools/SetScoreBoard", "NoiseStatus": noise_status}
        self._local_post(data)
